...
//	}
	...
	if(tempo.alive)
	{
		if(x - tempo.x < 150 && y - tempo.y < 150){
			...
			int x1 = x + playerX[i+1];
			int y1 = y + playerY[i+1];

			int x2 = x + playerX[i+2];
			int y2 = y + playerY[i+2];

//			double rad = 0.01744444 * angle;
//			int x0 = (int)(x + 15 * cos(rad + 1.57));
//			int y0 = (int)(y + 15 * sin(rad + 1.57));
//
//			int x1 = (int)(x + 15 * cos(rad + 3.925));
//			int y1 = (int)(y + 15 * sin(rad + 3.925));
//
//			int x2 = (int)(x + 15 * cos(rad + 5.495));
//			int y2 = (int)(y + 15 * sin(rad + 5.495));
