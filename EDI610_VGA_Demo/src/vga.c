...
//
//
//	drawLine(x+playerX[i],y+playerY[i],x+playerX[k],y+playerY[k], color);// right of the triangle
//	drawLine(x+playerX[k],y+playerY[k],x+playerX[j],y+playerY[j], color);// bottom of the triangle
